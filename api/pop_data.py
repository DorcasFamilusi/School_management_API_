...
def populate_db():
    students = [
        ...
        {'first_name':'Student','last_name': 'StudentB','email':'student1@gmail.com','password':'password123456',},
    ]
    admins = [
    ...
    lecturer = [
        {'first_name':'Lecturer','last_name': 'lecturerC','email':'lecturer56@gmail.com','password':'password123',},
        {'first_name':'Lecturer','last_name': 'lecturerD','email':'lecturer87@gmail.com','password':'password1234',},
    ]
    for user in admins:
    ...
    for course in courses:
        lecturer = Lecturer.query.filter_by(email='teacher1@gmail.com').first()
