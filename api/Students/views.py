...
add_courses_serializer = students_ns.model(model=courses_fields_serializer)
add_students_score_serializer = students_ns.model(model=add_students_score_fields_serializer)
students_serializer = students_ns.model(model=students_fields_serializer)
courses_serializer = students_ns.model(model=course_retrieve_fields_serializer)
