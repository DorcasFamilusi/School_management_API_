...
from ..pop_data import populate_db
...
add_courses_serializer = students_ns.model(courses_fields_serializer)
add_students_score_serializer = students_ns.model(add_students_score_fields_serializer)
students_serializer = students_ns.model(students_fields_serializer)
courses_serializer = students_ns.model( course_retrieve_fields_serializer)
    ...
    def post(self):
        ...
        if course:
            ...
            try:
                ...
                db.session.rollback()
                return {'message': 'An error occurred while you were registering for this  course'}, HTTPStatus.INTERNAL_SERVER_ERROR
    ...
    def put(self):
        ...
        if student_in_course:
            ...
            try:
                ...
                db.session.rollback()
                return {'message': 'An error occurred while saving the student course score'}, HTTPStatus.INTERNAL_SERVER_ERROR
